...
#define TRACKER_FWD_DUTY       0.250f   // full speed one direction (user-set; 5ms pulse - WAY above servo spec, will saturate + heat)
...
#define SOLAR_TEST_DUTY_MAX      0.400f  // end of scan (wide range)
