...
public:
	...
	static constexpr uint8_t UNUSED_PIN = NC;
	...
	/////////////////////////////////////////////////////////////////////////////////////
	MFRC522();
	MFRC522(PinName resetPowerDownPin);
	...
	/////////////////////////////////////////////////////////////////////////////////////
	void PCD_Init();
	void PCD_Init(PinName resetPowerDownPin);
	void PCD_Init(PinName chipSelectPin, PinName resetPowerDownPin);
	void PCD_Reset();
	void PCD_AntennaOn();
	void PCD_AntennaOff();
